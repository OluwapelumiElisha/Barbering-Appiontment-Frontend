...
const Slide = ({ slide, index, current, handleSlideClick }: SlideProps) => {
  ...
  return (
    <div className="[perspective:1200px] [transform-style:preserve-3d]">
      <li
        ref={slideRef}
        className="flex flex-1 flex-col items-center justify-center relative text-center text-white opacity-100 transition-all duration-300 ease-in-out w-[70vmin] lg:h-[70vmin] md:h-[70vmin]  sm::h-[80vmin]  h-[90vmin]  mx-[4vmin] z-10 "
      ...
      >
        ...
        >
          <h2 className={`text-lg md:text-2xl lg:text-4xl text-center font-semibold lg:-mt-0 md:-mt-0 sm:-mt-0 -mt-12 relative ${barlow.className}`}>
            {title}
          </h2>
